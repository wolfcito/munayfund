        ...
        <div className="container mx-auto py-8">
          <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
            <div className="col-span-4 sm:col-span-3">
              <div className="border border-lime-300 shadow rounded-lg p-6">
                ...
                <div className="flex flex-col">
                  <span className="text-gray-700 uppercase font-bold tracking-wider mb-2">Projects</span>
                  <ul>
                    <li className="mb-2">Saving the World</li>
                    <li className="mb-2">MunayFund</li>
                  </ul>
                </div>
              </div>
            </div>
            <div className="col-span-4 sm:col-span-9">
              <div className="border border-lime-300 shadow rounded-lg p-6">
                ...
                <h2 className="text-xl font-bold mt-6 mb-4">Past Projects</h2>
                <div className="mb-6">
                  <div className="flex justify-between flex-wrap gap-2 w-full">
                    <span className="text-gray-700 font-bold">Web Developer</span>
                    <p>
                      <span className="text-gray-700 mr-2">at Allo Hackathon</span>
