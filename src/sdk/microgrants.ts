...
import { Allocation, SetAllocatorData } from '@allo-team/allo-v2-sdk/dist/strategies/MicroGrantsStrategy/types'
...
export const deployMicrograntsStrategy = async (pointer: any, profileId: string) => {
  ...
  const poolCreationData: CreatePoolArgs = {
    ...
    managers: ['0x98aCac2dc4bb94748e33f092D7D70911b38AB76b'],
  }
...
export const allocate = async (data: Allocation) => {
  ...
  const allocatorData: SetAllocatorData[] = [
    {
      allocatorAddress: '0x98aCac2dc4bb94748e33f092D7D70911b38AB76b',
      flag: true,
    },
  ]
